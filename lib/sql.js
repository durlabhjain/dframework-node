                ...
                for(const parameter of Object.values(request.parameters)) {
                    switch(parameter.type) {
                        ...
                        case mssql.NVarChar:
                            ...
                            break;
                        case mssql.Decimal:
                            if(isNaN(parameter.scale)) parameter.scale = sqlParameterLength.decimal_scale;
                            if(isNaN(parameter.precision)) parameter.precision = sqlParameterLength.decimal_precision;
                            break;
                    }
                }
            }
