...
const sqlDataTypes = {
    varchar: util.useSqlParameterLength && util.sqlParameterLength.varchar ? mssql.VarChar(util.sqlParameterLength.varchar) : mssql.VarChar,
    nvarchar: util.useSqlParameterLength && util.sqlParameterLength.nvarchar ? mssql.NVarChar(util.sqlParameterLength.nvarchar) : mssql.NVarChar,
    decimal: util.useSqlParameterLength && util.sqlParameterLength.decimal_precision && util.sqlParameterLength.decimal_scale ? mssql.Decimal(util.sqlParameterLength.decimal_precision, util.sqlParameterLength.decimal_scale) : mssql.Decimal,
    datetime: util.useSqlParameterLength && util.sqlParameterLength.useDateTime2 ? mssql.DateTime2 : mssql.DateTime
}
            ...
            if(util.useSqlParameterLength) {
                for(const parameter of Object.values(request.parameters)) {
                    switch(parameter.type) {
                        case mssql.VarChar: 
                            parameter.length = util.sqlParameterLength.varchar ? util.sqlParameterLength.varchar : parameter.length;
                            break;
                        case mssql.NVarChar:
                            parameter.length = util.sqlParameterLength.nvarchar ? util.sqlParameterLength.nvarchar : parameter.length;
                            break;
                        case mssql.Decimal:
                            parameter.scale = util.sqlParameterLength.decimal_scale ? util.sqlParameterLength.decimal_scale : parameter.length;
                            parameter.precision = util.sqlParameterLength.decimal_precision ? util.sqlParameterLength.decimal_precision : parameter.length;
                            break;
                        case mssql.Date:
                            parameter.type = util.sqlParameterLength.useDateTime2 ? mssql.DateTime2.type : parameter.type;
                            break;
                    }
                }
            }
...
export { mssql, createQueryLogger, sqlDataTypes };