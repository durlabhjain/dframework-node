            ...
            if(util.useSqlParameterLength) {
                ...
                for(const parameter of Object.values(request.parameters)) {
                    switch(parameter.type) {
                        case mssql.VarChar: 
                            parameter.length = sqlParameterLength.varchar ?? parameter.length;
                            break;
                        case mssql.NVarChar:
                            parameter.length = sqlParameterLength.nvarchar ?? parameter.length;
                            break;
                        case mssql.Decimal:
                            parameter.scale = sqlParameterLength.decimal_scale ?? parameter.scale;
                            parameter.precision = sqlParameterLength.decimal_precision ?? parameter.precision;
                            break;
                        case mssql.Date:
