...
const sqlDataTypes = {
    varchar: util.useSqlParameterLength ? mssql.VarChar(util.sqlParameterLength.varchar) : mssql.VarChar,
    nvarchar: util.useSqlParameterLength ? mssql.NVarChar(util.sqlParameterLength.nvarchar) : mssql.NVarChar,
    decimal: util.useSqlParameterLength ? mssql.Decimal(util.sqlParameterLength.decimal_precision, util.sqlParameterLength.decimal_scale) : mssql.Decimal
}
