...
// Renders the log's UTC timestamp as a locale string instead of a raw ISO string
const formatUtcDate = (time) => new Date(time).toLocaleString("en-US", { timeZone: "UTC" });
