...
const responseTransformer = async function (req, res, next) {
    res.transform = async function ({ success, ...others }, { responseType, fileName, data: dataField = "data" } = {}) {
        ...
        let data = null;
        let dataArr = others?.dataField ? others?.dataField : [dataField];
        ...
        let userDateFormat, isElastic, userTimezoneOffset, dateTimeFormat, lookups, lookupFields, columns = {}, columnKeyMappings = {};
