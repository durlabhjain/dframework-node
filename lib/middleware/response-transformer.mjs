                    ...
                    data = data.map(record => {
                        ...
                        for (const [key, value] of Object.entries(record)) {
                            if (value instanceof Date) {
                                ...
                                formattedRecord[key] = formatDateTime({ value, format: hasTime ? dateTimeFormat : userDateFormat }); // This is a common format for dates in CSV
            ...
            case mimeTypes.xml:
                ...
                const formattedData = data.map(item => {
                    ...
                    for (const key in item) {
                        ...
                        newItem[formattedKey] = item[key]; // Keep the value unchanged
                        if (newItem[formattedKey] instanceof Date) {
                            const hasTime = newItem[formattedKey].getHours() + newItem[formattedKey].getMinutes() + newItem[formattedKey].getSeconds() + newItem[formattedKey].getMilliseconds() > 0;
                            newItem[formattedKey] = formatDateTime({ value: newItem[formattedKey], format: hasTime ? dateTimeFormat : userDateFormat }); // This is a common format for dates in CSV
                        } 
