    ...
    getLookup: async ({ lookupType, user, isForImport = true, tableLookupFields }) => {
        ...
        switch (lookupType) {
            ...
            case lookups.Role:
                ...
                break;
            case lookups.EmployerType:
                source = "vwClientLookupList";
                where["ClientId"] = user.scopeId;
                break;
            case lookups.KeyAccountType:
                source = "vwClientLookupList";
                where["ClientId"] = user.scopeId;
            ...
            case lookups.Market:
                ...
                break;
            case lookups.LocationClassification:
            ...
            case lookups.Asset:
                ...
                break;
            case lookups.Product:
                fields = "LookupId, SKU as DisplayValue";
                source = "vwProductLookupList";
                if (user.scopeId != 0)
                    where["ClientId"] = user.scopeId;
                break;
            case lookups.DoorHandleLocationType:
            case lookups.OrientationType:
                fields = "CustomValue AS LookupId, DisplayValue";
                break;
            case lookups.ExternalAssetCode:
