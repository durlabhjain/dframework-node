...
const render = async function ({ reportName, title, rows, toFile, columns, sheets, reportType = defaultFileType, settings, exportColumns, reportFolder = '.' }) {
...
const reports = {
    execute: async function ({ ReportType, options }) {
        ...
        await render({ title: report.title, rows, toFile: true, columns, sheets, reportType, settings: report.reportSettings || {}, exportColumns: report.exportColumns || false, reportFolder });
