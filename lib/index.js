...
class Controller {
    ...
    async list(listParameters) {
        ...
        return await framework.list({ controller, listParameters });
    }

    async listAll(listParameters) {
        const { framework, controller } = this;
        return await framework.listAll({ controller, listParameters });
    }
    ...
    async get(params) {
        ...
        const { framework, controller } = this;
        return await framework.query({ controller, params: { action: 'load', ...params } });
    }
    ...
    async save(id, params) {
        ...
        const { framework, controller } = this;
        return await framework.query({ controller, params: { action: 'save', ...params } });
    }
};
