...
class BusinessBaseObjectsRouter {
  ...
  setupRoutes() {
    ...
    const listOrExportHandler = queryBase(async (req, res) => {
      const { businessObject } = req;
    ...
    this.router.post('/:businessObjectName/list', listOrExportHandler);
    this.router.post('/:businessObjectName/export', listOrExportHandler);
