...
import { sqlDataTypes } from '../sql.js';
...
const compareLookups = {
    ...
    "is": function ({ v, type }) {
        ...
        if (dateTypeFields.includes(type)) {
            ...
            if (type === dateTimeEnum.DateTimeLocal) {
                toReturn = { operator: 'DATETIME', value: v, sqlType: sqlDataTypes.datetime }
            } else {
                toReturn = { operator: 'BETWEEN', value: values, sqlType: sqlDataTypes.varchar, type: type };
            }
        } else {
    ...
    "not": function ({ v, type }) {
        if (dateTypeFields.includes(type)) {
            ...
            if (type === dateTimeEnum.DateTimeLocal) {
                return { operator: 'NOT BETWEEN DATE', value: v, sqlType: sqlDataTypes.datetime, type: type };
            }
            return { operator: 'NOT BETWEEN', value: values, sqlType: sqlDataTypes.varchar, type: type };
        } else {
            return { operator: '!=', value: v, sqlType: sqlDataTypes.varchar, type: type };
        }
    },
    ...
    "isAnyOf": function ({ v, type }) {
        return { operator: 'IN', value: v, sqlType: sqlDataTypes.varchar, type: type };
    },
    "isTrue": function () {
