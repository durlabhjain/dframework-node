...
class BusinessBase {
    ...
    static lookupTypes = null;
    static tableLookupFields = null;

    logger = null;

    /**
     * Set project-specific lookup types for this business object
     * @param {Object} lookupTypes - Object containing lookup type constants
     */
    static setLookupTypes(lookupTypes) {
        this.lookupTypes = lookupTypes;
    }
    
    /**
     * Get lookup types for this business object
     * @returns {Object} Lookup types object
     */
    getLookupTypes() {
        return this.constructor.lookupTypes || {};
    }

    /**
     * Set project-specific table lookup fields for this business object
     * @param {Object} tableLookupFields - Object containing table lookup field configurations
     */
    static setTableLookupFields(tableLookupFields) {
        this.tableLookupFields = tableLookupFields;
    }
    
    /**
     * Get table lookup fields for this business object
     * @returns {Object} Table lookup fields object
     */
    getTableLookupFields() {
        return this.constructor.tableLookupFields || {};
    }
   ...
   */
    ...
    async loadLookups() {
        ...
        for (const lookupType of lookupTypes) {
            ...
            lookup[type] = await util.getLookup({ lookupType: typeId, user: this.user, sql, lookups: this.getLookupTypes() });
        }
        return lookup;
    }
}
