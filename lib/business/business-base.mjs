...
const compareLookups = {
    ...
    "is": function ({ v, type }) {
        ...
        if (dateTypeFields.includes(type)) {
            ...
            if (type === dateTimeEnum.DateTimeLocal) {
                ...
                toReturn = { operator: 'BETWEEN', value: values, sqlType: mssql.VarChar(util.sqlParameterLength["VarChar"]), type: type };
            }
        } else {
    ...
    "not": function ({ v, type }) {
        if (dateTypeFields.includes(type)) {
            ...
            return { operator: 'NOT BETWEEN', value: values, sqlType: mssql.VarChar(util.sqlParameterLength["VarChar"]), type: type };
        } else {
            return { operator: '!=', value: v, sqlType: mssql.VarChar(util.sqlParameterLength["VarChar"]), type: type };
        }
    },
    ...
    "isAnyOf": function ({ v, type }) {
        return { operator: 'IN', value: v, sqlType: mssql.VarChar(util.sqlParameterLength["VarChar"]), type: type };
    },
    "isTrue": function () {
